...
export const AboutModal: React.FC<AboutModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className="bg-[#FDF6F0] rounded-xl border-2 border-[#6D597A] shadow-[8px_8px_0px_#6D597A] w-full max-w-lg p-6 m-4 relative text-[#3A3A3A] transition-transform duration-300 animate-scaleIn"
      ...
      >
        ...
        <div className="flex items-center space-x-3 mb-4">
            <svg className="w-8 h-8 text-[#6D597A]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path></svg>
            <h2 className="text-2xl font-bold">Tentang iMagic</h2>
        </div>
