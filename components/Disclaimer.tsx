...
export const Disclaimer: React.FC = () => {
  return (
    <section className="mt-16 md:mt-24">
      <div className="bg-[#E56B6F]/10 border-2 border-[#E56B6F] rounded-xl p-6 shadow-[8px_8px_0px_#E56B6F]">
        <div className="flex items-start space-x-4">
          <div>
            <svg className="w-8 h-8 text-[#E56B6F]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
